...
public class Incremento extends Instruccion {
    ...
    public Incremento(String variable, int linea, int col) {
    ...
    public Object interpretar(Arbol arbol, tablaSimbolos tabla) {
        ...
        switch (simbolo.getTipo().getTipo()) {
            ...
            case tipoDato.DECIMAL:
                ...
                return null;
            default:
                return new Errores("SEMANTICO", "Incremento no válido para el tipo de dato de la variable '" + this.variable + "'", this.linea, this.col);
        }
    }
}
